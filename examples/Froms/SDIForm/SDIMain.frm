...
'#Region "Form"
	...
	Private Sub SDIMainType._ToolBar1_ButtonClick(ByRef Sender As ToolBar, ByRef Button As ToolButton)
		(*Cast(SDIMainType Ptr, Sender.Designer)).ToolBar1_ButtonClick(Sender, Button)
	End Sub
	
	Private Sub SDIMainType._mnuFile_Click(ByRef Sender As MenuItem)
		(*Cast(SDIMainType Ptr, Sender.Designer)).mnuFile_Click(Sender)
	End Sub
	
	Private Sub SDIMainType._mnuEdit_Click(ByRef Sender As MenuItem)
		(*Cast(SDIMainType Ptr, Sender.Designer)).mnuEdit_Click(Sender)
	End Sub
	
	Private Sub SDIMainType._mnuView_Click(ByRef Sender As MenuItem)
		(*Cast(SDIMainType Ptr, Sender.Designer)).mnuView_Click(Sender)
	End Sub
	
	Private Sub SDIMainType._mnuWindow_Click(ByRef Sender As MenuItem)
		(*Cast(SDIMainType Ptr, Sender.Designer)).mnuWindow_Click(Sender)
	End Sub
	
	Private Sub SDIMainType._mnuHelp_Click(ByRef Sender As MenuItem)
		(*Cast(SDIMainType Ptr, Sender.Designer)).mnuHelp_Click(Sender)
	End Sub
