'#Region "Form"
	...
	Constructor Form1Type
		...
		With chkOwnerData
			...
			.Designer = @This
			.OnClick = Cast(Sub(ByRef Designer As My.Sys.Object, ByRef Sender As Control), @chkOwnerData_Click)
			.Parent = @This
		End With
		' chkDarkMode
		With chkDarkMode
			...
			.Designer = @This
			.OnClick = Cast(Sub(ByRef Designer As My.Sys.Object, ByRef Sender As Control), @chkDarkMode_Click)
			.Parent = @This
		End With
	End Constructor
