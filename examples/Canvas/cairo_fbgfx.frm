'#Region "Form"
	...
	Type Form1Type Extends Form
		...
		Declare Sub Form_cairoCreateeate(ByRef Sender As Control)
	...
	Constructor Form1Type
		...
		With This
			...
			.OnCreate = Cast(Sub(ByRef Designer As My.Sys.Object, ByRef Sender As Control), @Form_cairoCreateeate)
...
Private Sub Form1Type.Form_cairoCreateeate(ByRef Sender As Control)
	'Initialize the drawing engine in sub Form_cairoCreateeate or Form_Show. The official freeBasic drawing engine is fbgfx,
	'and third-party drawing engines like RayLib are employed. It cannot be mixed simultaneously.
	'在Form_cairoCreateeate或者Form_Show初始化绘图引擎。freeBasic官方绘图引擎是fbgfx，第三方绘图引擎如RayLib。不能同时混用。
	#ifdef __fbgfx_bi__
