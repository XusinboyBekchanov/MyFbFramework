...
' Auto-translated from file /usr/share/gir-1.0/Gdk-4.0.gir
...
END ENUM
TYPE AS _GdkDrawContext GdkDrawContext
...
END ENUM
TYPE AS _GdkVulkanContext GdkVulkanContext
...
TYPE _GdkRectangle
  ...
  AS gint /'int'/ height
END TYPE
DECLARE FUNCTION gdk_rectangle_contains_point(BYVAL AS const GdkRectangle PTR, BYVAL AS gint /'int'/, BYVAL AS gint /'int'/) AS gboolean
...
TYPE _GdkEventTouchpadSwipe
  ...
  AS GdkWindow PTR window
  AS gint8 send_event
  AS GdkTouchpadGesturePhase phase
  AS gint8 n_fingers
  AS guint32 time
  AS gdouble x
  AS gdouble y
...
DECLARE FUNCTION gdk_event_get_user_data(BYVAL AS const GdkEvent PTR) AS GObject PTR
...
DECLARE SUB gdk_event_set_coords(BYVAL AS GdkEvent PTR, BYVAL AS gdouble, BYVAL AS gdouble)
...
DECLARE SUB gdk_event_set_user_data(BYVAL AS GdkEvent PTR, BYVAL AS GObject PTR)
...
DECLARE FUNCTION gdk_display_is_composited(BYVAL AS GdkDisplay PTR) AS gboolean
DECLARE FUNCTION gdk_display_is_rgba(BYVAL AS GdkDisplay PTR) AS gboolean
...
DECLARE FUNCTION gdk_draw_context_get_type() AS GType
...
#DEFINE GDK_DRAW_CONTEXT_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GDK_TYPE_DRAW_CONTEXT, Gdk))
#DEFINE GDK_IS_DRAW_CONTEXT(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GDK_TYPE_DRAW_CONTEXT))
#DEFINE GDK_IS_CLASS_DRAW_CONTEXT(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GDK_TYPE_DRAW_CONTEXT))
#DEFINE GDK_DRAW_CONTEXT_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), GDK_TYPE_DRAW_CONTEXT, Gdk))
DECLARE FUNCTION gdk_draw_context_get_display(BYVAL AS GdkDrawContext PTR) AS GdkDisplay PTR
DECLARE FUNCTION gdk_draw_context_get_window(BYVAL AS GdkDrawContext PTR) AS GdkWindow PTR
...
DECLARE FUNCTION gdk_drawing_context_get_paint_context(BYVAL AS GdkDrawingContext PTR) AS GdkDrawContext PTR
...
DECLARE FUNCTION gdk_gl_context_get_damage(BYVAL AS GdkGLContext PTR) AS cairo_region_t PTR
...
DECLARE FUNCTION gdk_rgba_is_clear(BYVAL AS const GdkRGBA PTR) AS gboolean
DECLARE FUNCTION gdk_rgba_is_opaque(BYVAL AS const GdkRGBA PTR) AS gboolean
...
DECLARE FUNCTION gdk_vulkan_context_get_type() AS GType
...
#DEFINE GDK_VULKAN_CONTEXT_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GDK_TYPE_VULKAN_CONTEXT, Gdk))
#DEFINE GDK_IS_VULKAN_CONTEXT(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GDK_TYPE_VULKAN_CONTEXT))
#DEFINE GDK_IS_CLASS_VULKAN_CONTEXT(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GDK_TYPE_VULKAN_CONTEXT))
#DEFINE GDK_VULKAN_CONTEXT_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), GDK_TYPE_VULKAN_CONTEXT, Gdk))
DECLARE FUNCTION gdk_vulkan_error_get_type() AS GType
...
DECLARE FUNCTION gdk_window_new_child(BYVAL AS GdkWindow PTR, BYVAL AS gint, BYVAL AS const GdkRectangle PTR) AS GdkWindow PTR
DECLARE FUNCTION gdk_window_new_input(BYVAL AS GdkWindow PTR, BYVAL AS gint, BYVAL AS const GdkRectangle PTR) AS GdkWindow PTR
DECLARE FUNCTION gdk_window_new_popup(BYVAL AS GdkDisplay PTR, BYVAL AS gint, BYVAL AS const GdkRectangle PTR) AS GdkWindow PTR
DECLARE FUNCTION gdk_window_new_temp(BYVAL AS GdkDisplay PTR) AS GdkWindow PTR
DECLARE FUNCTION gdk_window_new_toplevel(BYVAL AS GdkDisplay PTR, BYVAL AS gint, BYVAL AS gint /'int'/, BYVAL AS gint /'int'/) AS GdkWindow PTR
...
DECLARE FUNCTION gdk_window_begin_draw_frame(BYVAL AS GdkWindow PTR, BYVAL AS GdkDrawContext PTR, BYVAL AS const cairo_region_t PTR) AS GdkDrawingContext PTR
...
DECLARE FUNCTION gdk_window_create_vulkan_context(BYVAL AS GdkWindow PTR, BYVAL AS GError PTR PTR) AS GdkVulkanContext PTR
...
DECLARE SUB gdk_cairo_surface_upload_to_gl(BYVAL AS cairo_surface_t PTR, BYVAL AS gint /'int'/, BYVAL AS gint /'int'/, BYVAL AS gint /'int'/, BYVAL AS GdkGLContext PTR)
...
DECLARE FUNCTION gdk_pango_layout_line_get_clip_region(BYVAL AS PangoLayoutLine PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint PTR, BYVAL AS gint) AS cairo_region_t PTR
