...
' Auto-translated from file /usr/share/gir-1.0/Gtk-2.0.gir
...
TYPE AS GBaseInitFunc GtkClassInitFunc
TYPE AS GEnumValue GtkEnumValue
TYPE AS GFlagsValue GtkFlagValue
TYPE AS GType GtkFundamentalType
TYPE AS GInstanceInitFunc GtkObjectInitFunc
TYPE AS GSignalCMarshaller GtkSignalMarshaller
TYPE AS GType GtkType
TYPE AS GTypeClass GtkTypeClass
TYPE AS GTypeInstance GtkTypeObject
#DEFINE GTK_ARG_READWRITE 0
...
ENUM
  ...
  GTK_ANCHOR_E = 8
END ENUM
TYPE AS _GtkArg GtkArg
TYPE AS LONG GtkArgFlags
ENUM
  GTK_ARG_READABLE = 1
  GTK_ARG_WRITABLE = 2
  GTK_ARG_CONSTRUCT = 4
...
TYPE AS _GtkBoxChild GtkBoxChild
...
END ENUM
TYPE AS _GtkCList GtkCList
TYPE AS _GtkCListCellInfo GtkCListCellInfo
TYPE AS _GtkCListClass GtkCListClass
TYPE AS _GtkCListColumn GtkCListColumn
TYPE AS _GtkCListDestInfo GtkCListDestInfo
TYPE AS LONG GtkCListDragPos
ENUM
...
END ENUM
TYPE AS _GtkCListRow GtkCListRow
TYPE AS _GtkCTree GtkCTree
TYPE AS _GtkCTreeClass GtkCTreeClass
TYPE AS LONG GtkCTreeExpanderStyle
ENUM
...
END ENUM
TYPE AS LONG GtkCTreeExpansionType
ENUM
...
END ENUM
TYPE AS LONG GtkCTreeLineStyle
ENUM
...
END ENUM
TYPE AS _GtkCTreeNode GtkCTreeNode
TYPE AS LONG GtkCTreePos
ENUM
  GTK_CTREE_POS_BEFORE = 0
  GTK_CTREE_POS_AS_CHILD = 1
  GTK_CTREE_POS_AFTER = 2
END ENUM
TYPE AS _GtkCTreeRow GtkCTreeRow
...
TYPE AS _GtkCellPixText GtkCellPixText
TYPE AS _GtkCellPixmap GtkCellPixmap
...
TYPE AS _GtkCellText GtkCellText
TYPE AS LONG GtkCellType
ENUM
  GTK_CELL_EMPTY = 0
  GTK_CELL_TEXT = 1
  GTK_CELL_PIXMAP = 2
...
TYPE AS _GtkCellWidget GtkCellWidget
...
TYPE AS _GtkCombo GtkCombo
TYPE AS _GtkComboBox GtkComboBox
TYPE AS _GtkComboBoxClass GtkComboBoxClass
TYPE AS _GtkComboBoxEntry GtkComboBoxEntry
TYPE AS _GtkComboBoxEntryClass GtkComboBoxEntryClass
TYPE AS _GtkComboBoxEntryPrivate GtkComboBoxEntryPrivate
...
TYPE AS _GtkComboClass GtkComboClass
...
END ENUM
TYPE AS _GtkCurve GtkCurve
TYPE AS _GtkCurveClass GtkCurveClass
TYPE AS LONG GtkCurveType
ENUM
...
TYPE AS _GtkEditableClass GtkEditableClass
...
TYPE AS _GtkFileSelection GtkFileSelection
TYPE AS _GtkFileSelectionClass GtkFileSelectionClass
...
TYPE AS _GtkGammaCurve GtkGammaCurve
TYPE AS _GtkGammaCurveClass GtkGammaCurveClass
...
TYPE AS _GtkHRuler GtkHRuler
TYPE AS _GtkHRulerClass GtkHRulerClass
...
TYPE AS _GtkIdentifier GtkIdentifier
TYPE AS _GtkImage GtkImage
TYPE AS _GtkImageAnimationData GtkImageAnimationData
TYPE AS _GtkImageClass GtkImageClass
TYPE AS _GtkImageGIconData GtkImageGIconData
TYPE AS _GtkImageIconNameData GtkImageIconNameData
TYPE AS _GtkImageIconSetData GtkImageIconSetData
TYPE AS _GtkImageImageData GtkImageImageData
TYPE AS _GtkImageMenuItem GtkImageMenuItem
TYPE AS _GtkImageMenuItemClass GtkImageMenuItemClass
TYPE AS _GtkImagePixbufData GtkImagePixbufData
TYPE AS _GtkImagePixmapData GtkImagePixmapData
TYPE AS _GtkImageStockData GtkImageStockData
...
TYPE AS _GtkInputDialog GtkInputDialog
TYPE AS _GtkInputDialogClass GtkInputDialogClass
TYPE AS _GtkInvisible GtkInvisible
TYPE AS _GtkInvisibleClass GtkInvisibleClass
TYPE AS _GtkItem GtkItem
TYPE AS _GtkItemClass GtkItemClass
TYPE AS _GtkItemFactory GtkItemFactory
TYPE AS _GtkItemFactoryClass GtkItemFactoryClass
TYPE AS _GtkItemFactoryEntry GtkItemFactoryEntry
TYPE AS _GtkItemFactoryItem GtkItemFactoryItem
...
TYPE AS _GtkList GtkList
TYPE AS _GtkListClass GtkListClass
TYPE AS _GtkListItem GtkListItem
TYPE AS _GtkListItemClass GtkListItemClass
...
ENUM
  ...
  GTK_MENU_DIR_PREV = 3
END ENUM
TYPE AS _GtkMenuEntry GtkMenuEntry
...
END ENUM
#DEFINE GTK_NO_TEXT_INPUT_MOD_MASK 0
TYPE AS _GtkNotebook GtkNotebook
TYPE AS _GtkNotebookClass GtkNotebookClass
TYPE AS _GtkNotebookPage GtkNotebookPage
...
END ENUM
TYPE AS _GtkObject GtkObject
TYPE AS _GtkObjectClass GtkObjectClass
TYPE AS LONG GtkObjectFlags
ENUM
...
TYPE AS _GtkOldEditable GtkOldEditable
TYPE AS _GtkOldEditableClass GtkOldEditableClass
TYPE AS _GtkOptionMenu GtkOptionMenu
TYPE AS _GtkOptionMenuClass GtkOptionMenuClass
...
#DEFINE GTK_PARAM_READABLE 0
#DEFINE GTK_PARAM_READWRITE 0
#DEFINE GTK_PARAM_WRITABLE 0
...
ENUM
  ...
  GTK_PATH_CLASS = 2
END ENUM
TYPE AS _GtkPixmap GtkPixmap
TYPE AS _GtkPixmapClass GtkPixmapClass
...
ENUM
  ...
  GTK_POS_BOTTOM = 3
END ENUM
TYPE AS _GtkPreview GtkPreview
TYPE AS _GtkPreviewClass GtkPreviewClass
TYPE AS _GtkPreviewInfo GtkPreviewInfo
TYPE AS LONG GtkPreviewType
ENUM
  GTK_PREVIEW_COLOR = 0
...
END ENUM
TYPE AS LONG GtkProgressBarStyle
ENUM
  GTK_PROGRESS_CONTINUOUS = 0
  GTK_PROGRESS_DISCRETE = 1
END ENUM
TYPE AS _GtkProgressClass GtkProgressClass
...
TYPE AS _GtkRangeLayout GtkRangeLayout
TYPE AS _GtkRangeStepTimer GtkRangeStepTimer
...
END ENUM
TYPE AS _GtkRuler GtkRuler
TYPE AS _GtkRulerClass GtkRulerClass
TYPE AS _GtkRulerMetric GtkRulerMetric
...
TYPE AS _GtkSettingsPropertyValue GtkSettingsPropertyValue
...
TYPE AS LONG GtkSubmenuDirection
ENUM
  GTK_DIRECTION_LEFT = 0
  GTK_DIRECTION_RIGHT = 1
END ENUM
TYPE AS LONG GtkSubmenuPlacement
ENUM
  GTK_TOP_BOTTOM = 0
  GTK_LEFT_RIGHT = 1
END ENUM
...
#DEFINE GTK_TYPE_FUNDAMENTAL_LAST -1
...
TYPE AS _GtkTextAttrAppearance GtkTextAttrAppearance
...
TYPE AS _GtkTextCursorDisplay GtkTextCursorDisplay
...
TYPE AS _GtkTextLayout GtkTextLayout
TYPE AS _GtkTextLayoutClass GtkTextLayoutClass
TYPE AS _GtkTextLine GtkTextLine
TYPE AS _GtkTextLineData GtkTextLineData
TYPE AS _GtkTextLineDisplay GtkTextLineDisplay
TYPE AS _GtkTextLogAttrCache GtkTextLogAttrCache
TYPE AS _GtkTextMark GtkTextMark
TYPE AS _GtkTextMarkClass GtkTextMarkClass
TYPE AS _GtkTextPendingScroll GtkTextPendingScroll
...
TYPE AS _GtkTextWindow GtkTextWindow
...
TYPE AS _GtkTipsQuery GtkTipsQuery
TYPE AS _GtkTipsQueryClass GtkTipsQueryClass
...
TYPE AS _GtkToolbarChild GtkToolbarChild
TYPE AS LONG GtkToolbarChildType
ENUM
...
TYPE AS _GtkTooltips GtkTooltips
TYPE AS _GtkTooltipsClass GtkTooltipsClass
TYPE AS _GtkTooltipsData GtkTooltipsData
...
TYPE AS _GtkVRuler GtkVRuler
TYPE AS _GtkVRulerClass GtkVRulerClass
...
TYPE AS _GtkWidgetAuxInfo GtkWidgetAuxInfo
TYPE AS _GtkWidgetClass GtkWidgetClass
TYPE AS LONG GtkWidgetFlags
ENUM
  GTK_TOPLEVEL = 16
  GTK_NO_WINDOW = 32
  GTK_REALIZED = 64
...
END ENUM
TYPE AS _GtkWidgetShapeInfo GtkWidgetShapeInfo
...
#DEFINE GTK_OBJECT(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), GTK_TYPE_OBJECT, GtkObject))
#DEFINE GTK_OBJECT_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_OBJECT, GtkObjectClass))
#DEFINE GTK_IS_OBJECT(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_OBJECT))
#DEFINE GTK_IS_CLASS_OBJECT(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_OBJECT))
#DEFINE GTK_OBJECT_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), GTK_TYPE_OBJECT, GtkObjectClass))
...
TYPE _GtkWindowClass
  ...
  _gtk_reserved4 AS SUB CDECL()
END TYPE
TYPE GtkAboutDialogActivateLinkFunc AS SUB CDECL(BYVAL AS GtkAboutDialog PTR, BYVAL AS const gchar PTR, BYVAL AS gpointer)
TYPE _GtkDialog
  AS GtkWindow window
...
TYPE _GtkCellRendererClass
  ...
  activate AS FUNCTION CDECL(BYVAL AS GtkCellRenderer PTR, BYVAL AS GdkEvent PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS GdkRectangle PTR, BYVAL AS GdkRectangle PTR, BYVAL AS GtkCellRendererState) AS gboolean
  start_editing AS FUNCTION CDECL(BYVAL AS GtkCellRenderer PTR, BYVAL AS GdkEvent PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS GdkRectangle PTR, BYVAL AS GdkRectangle PTR, BYVAL AS GtkCellRendererState) AS GtkCellEditable PTR
...
#DEFINE GTK_ITEM_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_ITEM, GtkItemClass))
#DEFINE GTK_IS_ITEM(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_ITEM))
#DEFINE GTK_IS_CLASS_ITEM(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_ITEM))
...
#DEFINE GTK_RULER_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_RULER, GtkRulerClass))
#DEFINE GTK_IS_RULER(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_RULER))
#DEFINE GTK_IS_CLASS_RULER(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_RULER))
...
TYPE GtkLinkButtonUriFunc AS SUB CDECL(BYVAL AS GtkLinkButton PTR, BYVAL AS const gchar PTR, BYVAL AS gpointer)
...
TYPE _GtkToolItemClass
  ...
  set_tooltip AS FUNCTION CDECL(BYVAL AS GtkToolItem PTR, BYVAL AS GtkTooltips PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR) AS gboolean
  _gtk_reserved1 AS SUB CDECL()
  _gtk_reserved2 AS SUB CDECL()
  _gtk_reserved3 AS SUB CDECL()
  _gtk_reserved4 AS SUB CDECL()
...
TYPE _GtkToolButtonClass
  ...
  _gtk_reserved4 AS SUB CDECL()
END TYPE
TYPE GtkNotebookWindowCreationFunc AS FUNCTION CDECL(BYVAL AS GtkNotebook PTR, BYVAL AS GtkWidget PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gpointer) AS GtkNotebook PTR
...
#DEFINE GTK_CLIST_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_CLIST, GtkCListClass))
#DEFINE GTK_IS_CLIST(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_CLIST))
#DEFINE GTK_IS_CLASS_CLIST(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_CLIST))
...
DECLARE FUNCTION gtk_clist_new_with_titles(BYVAL AS gint, BYVAL AS gchar PTR) AS GtkWidget PTR
DECLARE FUNCTION gtk_clist_append(BYVAL AS GtkCList PTR, BYVAL AS gchar PTR) AS gint
...
DECLARE FUNCTION gtk_clist_insert(BYVAL AS GtkCList PTR, BYVAL AS gint, BYVAL AS gchar PTR) AS gint
...
DECLARE FUNCTION gtk_clist_prepend(BYVAL AS GtkCList PTR, BYVAL AS gchar PTR) AS gint
...
TYPE _GtkCListClass
  ...
  selection_find AS FUNCTION CDECL(BYVAL AS GtkCList PTR, BYVAL AS gint, BYVAL AS GList PTR) AS GList PTR
  ...
  insert_row AS FUNCTION CDECL(BYVAL AS GtkCList PTR, BYVAL AS gint, BYVAL AS gchar PTR) AS gint
  remove_row AS SUB CDECL(BYVAL AS GtkCList PTR, BYVAL AS gint)
  set_cell_contents AS SUB CDECL(BYVAL AS GtkCList PTR, BYVAL AS GtkCListRow PTR, BYVAL AS gint, BYVAL AS GtkCellType, BYVAL AS const gchar PTR, BYVAL AS guint8, BYVAL AS GdkPixmap PTR, BYVAL AS GdkBitmap PTR)
...
#DEFINE GTK_CTREE_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_CTREE, GtkCTreeClass))
#DEFINE GTK_IS_CTREE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_CTREE))
#DEFINE GTK_IS_CLASS_CTREE(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_CTREE))
...
DECLARE FUNCTION gtk_ctree_new_with_titles(BYVAL AS gint, BYVAL AS gint, BYVAL AS gchar PTR) AS GtkWidget PTR
...
DECLARE FUNCTION gtk_ctree_insert_node(BYVAL AS GtkCTree PTR, BYVAL AS GtkCTreeNode PTR, BYVAL AS GtkCTreeNode PTR, BYVAL AS gchar PTR, BYVAL AS guint8, BYVAL AS GdkPixmap PTR, BYVAL AS GdkBitmap PTR, BYVAL AS GdkPixmap PTR, BYVAL AS GdkBitmap PTR, BYVAL AS gboolean, BYVAL AS gboolean) AS GtkCTreeNode PTR
...
DECLARE FUNCTION gtk_color_selection_palette_to_string(BYVAL AS GdkColor PTR, BYVAL AS gint) AS gchar PTR
...
#DEFINE GTK_COMBO_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_COMBO, GtkComboClass))
#DEFINE GTK_IS_COMBO(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_COMBO))
#DEFINE GTK_IS_CLASS_COMBO(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_COMBO))
...
TYPE _GtkComboBoxClass
  ...
  get_active_text AS FUNCTION CDECL(BYVAL AS GtkComboBox PTR) AS gchar PTR
  _gtk_reserved0 AS SUB CDECL()
  _gtk_reserved1 AS SUB CDECL()
  _gtk_reserved2 AS SUB CDECL()
END TYPE
...
#DEFINE GTK_COMBO_BOX_ENTRY_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_COMBO_BOX_ENTRY, GtkComboBoxEntryClass))
#DEFINE GTK_IS_COMBO_BOX_ENTRY(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_COMBO_BOX_ENTRY))
#DEFINE GTK_IS_CLASS_COMBO_BOX_ENTRY(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_COMBO_BOX_ENTRY))
#DEFINE GTK_COMBO_BOX_ENTRY_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), GTK_TYPE_COMBO_BOX_ENTRY, GtkComboBoxEntryClass))
...
#DEFINE GTK_CURVE_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_CURVE, GtkCurveClass))
#DEFINE GTK_IS_CURVE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_CURVE))
#DEFINE GTK_IS_CLASS_CURVE(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_CURVE))
...
DECLARE SUB gtk_curve_get_vector(BYVAL AS GtkCurve PTR, BYVAL AS gint /'int'/, BYVAL AS gfloat)
...
DECLARE SUB gtk_curve_set_vector(BYVAL AS GtkCurve PTR, BYVAL AS gint /'int'/, BYVAL AS gfloat)
TYPE _GtkCurveClass
...
#DEFINE GTK_EDITABLE_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_EDITABLE, Gtk))
#DEFINE GTK_IS_EDITABLE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_EDITABLE))
#DEFINE GTK_EDITABLE_GET_IFACE(obj) (G_TYPE_INSTANCE_GET_INTERFACE((obj), GTK_TYPE_EDITABLE, Gtk))
...
TYPE _GtkFileChooserButtonClass
  ...
  AS any /'void'/ PTR __gtk_reserved5
  AS any /'void'/ PTR __gtk_reserved6
  AS any /'void'/ PTR __gtk_reserved7
END TYPE
...
#DEFINE GTK_FILE_SELECTION_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_FILE_SELECTION, GtkFileSelectionClass))
#DEFINE GTK_IS_FILE_SELECTION(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_FILE_SELECTION))
#DEFINE GTK_IS_CLASS_FILE_SELECTION(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_FILE_SELECTION))
...
#DEFINE GTK_GAMMA_CURVE_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_GAMMA_CURVE, GtkGammaCurveClass))
#DEFINE GTK_IS_GAMMA_CURVE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_GAMMA_CURVE))
#DEFINE GTK_IS_CLASS_GAMMA_CURVE(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_GAMMA_CURVE))
...
#DEFINE GTK_HRULER_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_HRULER, GtkHRulerClass))
#DEFINE GTK_IS_HRULER(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_HRULER))
#DEFINE GTK_IS_CLASS_HRULER(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_HRULER))
...
DECLARE FUNCTION gtk_icon_set_render_icon(BYVAL AS GtkIconSet PTR, BYVAL AS GtkStyle PTR, BYVAL AS GtkTextDirection, BYVAL AS GtkStateType, BYVAL AS GtkIconSize, BYVAL AS GtkWidget PTR, BYVAL AS const char PTR) AS GdkPixbuf PTR
...
#DEFINE GTK_IDENTIFIER(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), GTK_TYPE_IDENTIFIER, GtkIdentifier))
#DEFINE GTK_IDENTIFIER_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_IDENTIFIER, Gtk))
#DEFINE GTK_IS_IDENTIFIER(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_IDENTIFIER))
#DEFINE GTK_IS_CLASS_IDENTIFIER(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_IDENTIFIER))
#DEFINE GTK_IDENTIFIER_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), GTK_TYPE_IDENTIFIER, Gtk))
TYPE _GtkImage
  AS GtkMisc misc
...
#DEFINE GTK_INPUT_DIALOG_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_INPUT_DIALOG, GtkInputDialogClass))
#DEFINE GTK_IS_INPUT_DIALOG(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_INPUT_DIALOG))
#DEFINE GTK_IS_CLASS_INPUT_DIALOG(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_INPUT_DIALOG))
...
#DEFINE GTK_ITEM_FACTORY(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), GTK_TYPE_ITEM_FACTORY, GtkItemFactory))
#DEFINE GTK_ITEM_FACTORY_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_ITEM_FACTORY, GtkItemFactoryClass))
#DEFINE GTK_IS_ITEM_FACTORY(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_ITEM_FACTORY))
#DEFINE GTK_IS_CLASS_ITEM_FACTORY(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_ITEM_FACTORY))
...
#DEFINE GTK_LIST_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_LIST, GtkListClass))
#DEFINE GTK_IS_LIST(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_LIST))
#DEFINE GTK_IS_CLASS_LIST(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_LIST))
...
#DEFINE GTK_LIST_ITEM_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_LIST_ITEM, GtkListItemClass))
#DEFINE GTK_IS_LIST_ITEM(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_LIST_ITEM))
#DEFINE GTK_IS_CLASS_LIST_ITEM(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_LIST_ITEM))
...
#DEFINE GTK_OLD_EDITABLE_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_OLD_EDITABLE, GtkOldEditableClass))
#DEFINE GTK_IS_OLD_EDITABLE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_OLD_EDITABLE))
#DEFINE GTK_IS_CLASS_OLD_EDITABLE(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_OLD_EDITABLE))
...
TYPE _GtkOldEditableClass
  ...
  get_chars AS FUNCTION CDECL(BYVAL AS GtkOldEditable PTR, BYVAL AS gint, BYVAL AS gint) AS gchar PTR
...
#DEFINE GTK_OPTION_MENU_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_OPTION_MENU, GtkOptionMenuClass))
#DEFINE GTK_IS_OPTION_MENU(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_OPTION_MENU))
#DEFINE GTK_IS_CLASS_OPTION_MENU(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_OPTION_MENU))
...
#DEFINE GTK_PIXMAP_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_PIXMAP, GtkPixmapClass))
#DEFINE GTK_IS_PIXMAP(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_PIXMAP))
#DEFINE GTK_IS_CLASS_PIXMAP(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_PIXMAP))
...
#DEFINE GTK_PREVIEW_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_PREVIEW, GtkPreviewClass))
#DEFINE GTK_IS_PREVIEW(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_PREVIEW))
#DEFINE GTK_IS_CLASS_PREVIEW(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_PREVIEW))
...
TYPE GtkPrintFunc AS SUB CDECL(BYVAL AS gpointer, BYVAL AS const gchar PTR)
...
#DEFINE GTK_PROGRESS_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_PROGRESS, GtkProgressClass))
#DEFINE GTK_IS_PROGRESS(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_PROGRESS))
#DEFINE GTK_IS_CLASS_PROGRESS(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_PROGRESS))
...
DECLARE FUNCTION gtk_selection_data_get_data_type(BYVAL AS GtkSelectionData PTR) AS any ptr /'GdkAtom'/
...
DECLARE FUNCTION gtk_selection_data_get_selection(BYVAL AS GtkSelectionData PTR) AS any ptr /'GdkAtom'/
DECLARE FUNCTION gtk_selection_data_get_target(BYVAL AS GtkSelectionData PTR) AS any ptr /'GdkAtom'/
DECLARE FUNCTION gtk_selection_data_get_targets(BYVAL AS GtkSelectionData PTR, BYVAL AS any ptr /'GdkAtom'/ PTR PTR, BYVAL AS gint PTR) AS gboolean
...
TYPE _GtkStyleClass
  ...
  draw_hline AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_vline AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_shadow AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_polygon AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS GdkPoint PTR, BYVAL AS gint, BYVAL AS gboolean)
  draw_arrow AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS GtkArrowType, BYVAL AS gboolean, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_diamond AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_string AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS const gchar PTR)
  draw_box AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_flat_box AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_check AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_option AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_tab AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_shadow_gap AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS GtkPositionType, BYVAL AS gint, BYVAL AS gint)
  draw_box_gap AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS GtkPositionType, BYVAL AS gint, BYVAL AS gint)
  draw_extension AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS GtkPositionType)
  draw_focus AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_slider AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS GtkOrientation)
  draw_handle AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GtkShadowType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS GtkOrientation)
  draw_expander AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS GtkExpanderStyle)
  draw_layout AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS gboolean, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS PangoLayout PTR)
  draw_resize_grip AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS GdkWindowEdge, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  draw_spinner AS SUB CDECL(BYVAL AS GtkStyle PTR, BYVAL AS GdkWindow PTR, BYVAL AS GtkStateType, BYVAL AS GdkRectangle PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS guint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  _gtk_reserved1 AS SUB CDECL()
  _gtk_reserved2 AS SUB CDECL()
  _gtk_reserved3 AS SUB CDECL()
  _gtk_reserved4 AS SUB CDECL()
...
DECLARE SUB gtk_text_child_anchor_queue_resize(BYVAL AS GtkTextChildAnchor PTR, BYVAL AS GtkTextLayout PTR)
DECLARE SUB gtk_text_child_anchor_register_child(BYVAL AS GtkTextChildAnchor PTR, BYVAL AS GtkWidget PTR, BYVAL AS GtkTextLayout PTR)
DECLARE SUB gtk_text_child_anchor_unregister_child(BYVAL AS GtkTextChildAnchor PTR, BYVAL AS GtkWidget PTR)
TYPE _GtkTextChildAnchorClass
  ...
  _gtk_reserved4 AS SUB CDECL()
END TYPE
TYPE _GtkTextCursorDisplay
  AS gint x
  AS gint y
  AS gint height
  AS guint is_strong : 1
  AS guint is_weak : 1
END TYPE
...
TYPE _GtkTextLayout
  AS GObject parent_instance
  AS gint screen_width
  AS gint width
  AS gint height
  AS GtkTextBuffer PTR buffer
  AS GtkTextAttributes PTR default_style
  AS PangoContext PTR ltr_context
  AS PangoContext PTR rtl_context
  AS GtkTextAttributes PTR one_style_cache
  AS GtkTextLineDisplay PTR one_display_cache
  AS gint wrap_loop_count
  AS guint cursor_visible : 1
  AS guint cursor_direction : 2
  AS guint keyboard_direction : 2
  AS gchar PTR preedit_string
  AS PangoAttrList PTR preedit_attrs
  AS gint preedit_len
  AS gint preedit_cursor
  AS guint overwrite_mode : 1
END TYPE
DECLARE FUNCTION gtk_text_layout_get_type() AS GType
...
#DEFINE GTK_TEXT_LAYOUT_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_TEXT_LAYOUT, GtkTextLayoutClass))
#DEFINE GTK_IS_TEXT_LAYOUT(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_TEXT_LAYOUT))
#DEFINE GTK_IS_CLASS_TEXT_LAYOUT(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_TEXT_LAYOUT))
#DEFINE GTK_TEXT_LAYOUT_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), GTK_TYPE_TEXT_LAYOUT, GtkTextLayoutClass))
DECLARE FUNCTION gtk_text_layout_new() AS GtkTextLayout PTR
DECLARE SUB gtk_text_layout_changed(BYVAL AS GtkTextLayout PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
DECLARE FUNCTION gtk_text_layout_clamp_iter_to_vrange(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS gint, BYVAL AS gint) AS gboolean
DECLARE SUB gtk_text_layout_cursors_changed(BYVAL AS GtkTextLayout PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
DECLARE SUB gtk_text_layout_default_style_changed(BYVAL AS GtkTextLayout PTR)
DECLARE SUB gtk_text_layout_draw(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkWidget PTR, BYVAL AS GdkDrawable PTR, BYVAL AS GdkGC PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint, BYVAL AS GList PTR PTR)
DECLARE SUB gtk_text_layout_free_line_data(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextLine PTR, BYVAL AS GtkTextLineData PTR)
DECLARE SUB gtk_text_layout_free_line_display(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextLineDisplay PTR)
DECLARE FUNCTION gtk_text_layout_get_buffer(BYVAL AS GtkTextLayout PTR) AS GtkTextBuffer PTR
DECLARE SUB gtk_text_layout_get_cursor_locations(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS GdkRectangle PTR, BYVAL AS GdkRectangle PTR)
DECLARE FUNCTION gtk_text_layout_get_cursor_visible(BYVAL AS GtkTextLayout PTR) AS gboolean
DECLARE SUB gtk_text_layout_get_iter_at_line(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS GtkTextLine PTR, BYVAL AS gint)
DECLARE SUB gtk_text_layout_get_iter_at_pixel(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS gint, BYVAL AS gint)
DECLARE SUB gtk_text_layout_get_iter_at_position(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS gint PTR, BYVAL AS gint, BYVAL AS gint)
DECLARE SUB gtk_text_layout_get_iter_location(BYVAL AS GtkTextLayout PTR, BYVAL AS const GtkTextIter PTR, BYVAL AS GdkRectangle PTR)
DECLARE SUB gtk_text_layout_get_line_at_y(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS gint, BYVAL AS gint PTR)
DECLARE FUNCTION gtk_text_layout_get_line_display(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextLine PTR, BYVAL AS gboolean) AS GtkTextLineDisplay PTR
DECLARE SUB gtk_text_layout_get_line_yrange(BYVAL AS GtkTextLayout PTR, BYVAL AS const GtkTextIter PTR, BYVAL AS gint PTR, BYVAL AS gint PTR)
DECLARE FUNCTION gtk_text_layout_get_lines(BYVAL AS GtkTextLayout PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint PTR) AS GSList PTR
DECLARE SUB gtk_text_layout_get_size(BYVAL AS GtkTextLayout PTR, BYVAL AS gint PTR, BYVAL AS gint PTR)
DECLARE SUB gtk_text_layout_invalidate(BYVAL AS GtkTextLayout PTR, BYVAL AS const GtkTextIter PTR, BYVAL AS const GtkTextIter PTR)
DECLARE SUB gtk_text_layout_invalidate_cursors(BYVAL AS GtkTextLayout PTR, BYVAL AS const GtkTextIter PTR, BYVAL AS const GtkTextIter PTR)
DECLARE FUNCTION gtk_text_layout_is_valid(BYVAL AS GtkTextLayout PTR) AS gboolean
DECLARE FUNCTION gtk_text_layout_iter_starts_line(BYVAL AS GtkTextLayout PTR, BYVAL AS const GtkTextIter PTR) AS gboolean
DECLARE FUNCTION gtk_text_layout_move_iter_to_line_end(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS gint) AS gboolean
DECLARE FUNCTION gtk_text_layout_move_iter_to_next_line(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR) AS gboolean
DECLARE FUNCTION gtk_text_layout_move_iter_to_previous_line(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR) AS gboolean
DECLARE SUB gtk_text_layout_move_iter_to_x(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS gint)
DECLARE FUNCTION gtk_text_layout_move_iter_visually(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS gint) AS gboolean
DECLARE SUB gtk_text_layout_set_buffer(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextBuffer PTR)
DECLARE SUB gtk_text_layout_set_contexts(BYVAL AS GtkTextLayout PTR, BYVAL AS PangoContext PTR, BYVAL AS PangoContext PTR)
DECLARE SUB gtk_text_layout_set_cursor_direction(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextDirection)
DECLARE SUB gtk_text_layout_set_cursor_visible(BYVAL AS GtkTextLayout PTR, BYVAL AS gboolean)
DECLARE SUB gtk_text_layout_set_default_style(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextAttributes PTR)
DECLARE SUB gtk_text_layout_set_keyboard_direction(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextDirection)
DECLARE SUB gtk_text_layout_set_overwrite_mode(BYVAL AS GtkTextLayout PTR, BYVAL AS gboolean)
DECLARE SUB gtk_text_layout_set_preedit_string(BYVAL AS GtkTextLayout PTR, BYVAL AS const gchar PTR, BYVAL AS PangoAttrList PTR, BYVAL AS gint)
DECLARE SUB gtk_text_layout_set_screen_width(BYVAL AS GtkTextLayout PTR, BYVAL AS gint)
DECLARE SUB gtk_text_layout_spew(BYVAL AS GtkTextLayout PTR)
DECLARE SUB gtk_text_layout_validate(BYVAL AS GtkTextLayout PTR, BYVAL AS gint)
DECLARE SUB gtk_text_layout_validate_yrange(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextIter PTR, BYVAL AS gint, BYVAL AS gint)
DECLARE FUNCTION gtk_text_layout_wrap(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextLine PTR, BYVAL AS GtkTextLineData PTR) AS GtkTextLineData PTR
DECLARE SUB gtk_text_layout_wrap_loop_end(BYVAL AS GtkTextLayout PTR)
DECLARE SUB gtk_text_layout_wrap_loop_start(BYVAL AS GtkTextLayout PTR)
TYPE _GtkTextLayoutClass
  AS GObjectClass parent_class
  invalidated AS SUB CDECL(BYVAL AS GtkTextLayout PTR)
  changed AS SUB CDECL(BYVAL AS GtkTextLayout PTR, BYVAL AS gint, BYVAL AS gint, BYVAL AS gint)
  wrap AS FUNCTION CDECL(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextLine PTR, BYVAL AS GtkTextLineData PTR) AS GtkTextLineData PTR
  get_log_attrs AS SUB CDECL(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextLine PTR, BYVAL AS PangoLogAttr PTR PTR, BYVAL AS gint PTR)
  invalidate AS SUB CDECL(BYVAL AS GtkTextLayout PTR, BYVAL AS const GtkTextIter PTR, BYVAL AS const GtkTextIter PTR)
  free_line_data AS SUB CDECL(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkTextLine PTR, BYVAL AS GtkTextLineData PTR)
  allocate_child AS SUB CDECL(BYVAL AS GtkTextLayout PTR, BYVAL AS GtkWidget PTR, BYVAL AS gint, BYVAL AS gint)
  invalidate_cursors AS SUB CDECL(BYVAL AS GtkTextLayout PTR, BYVAL AS const GtkTextIter PTR, BYVAL AS const GtkTextIter PTR)
  _gtk_reserved1 AS SUB CDECL()
  _gtk_reserved2 AS SUB CDECL()
  _gtk_reserved3 AS SUB CDECL()
END TYPE
TYPE _GtkTextLineDisplay
  AS PangoLayout PTR layout
  AS GSList PTR cursors
  AS GSList PTR shaped_objects
  AS GtkTextDirection direction
  AS gint width
  AS gint total_width
  AS gint height
  ...
  AS gint right_margin
  AS gint top_margin
  AS gint bottom_margin
  AS gint insert_index
  AS gboolean size_only
  AS GtkTextLine PTR line
  AS GdkColor PTR pg_bg_color
  AS GdkRectangle block_cursor
  AS guint cursors_invalid : 1
  AS guint has_block_cursor : 1
  AS guint cursor_at_line_end : 1
END TYPE
TYPE _GtkTextMark
  AS GObject parent_instance
  AS gpointer segment
...
#DEFINE GTK_TIPS_QUERY_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_TIPS_QUERY, GtkTipsQueryClass))
#DEFINE GTK_IS_TIPS_QUERY(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_TIPS_QUERY))
#DEFINE GTK_IS_CLASS_TIPS_QUERY(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_TIPS_QUERY))
...
TYPE _GtkTipsQueryClass
  ...
  widget_entered AS SUB CDECL(BYVAL AS GtkTipsQuery PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR)
  widget_selected AS FUNCTION CDECL(BYVAL AS GtkTipsQuery PTR, BYVAL AS GtkWidget PTR, BYVAL AS const gchar PTR, BYVAL AS const gchar PTR, BYVAL AS GdkEventButton PTR) AS gint
  _gtk_reserved1 AS SUB CDECL()
  _gtk_reserved2 AS SUB CDECL()
  _gtk_reserved3 AS SUB CDECL()
  _gtk_reserved4 AS SUB CDECL()
...
TYPE _GtkToolPaletteClass
  AS GtkContainerClass parent_class
  set_scroll_adjustments AS SUB CDECL(BYVAL AS GtkWidget PTR, BYVAL AS GtkAdjustment PTR, BYVAL AS GtkAdjustment PTR)
  _gtk_reserved1 AS SUB CDECL()
  _gtk_reserved2 AS SUB CDECL()
  _gtk_reserved3 AS SUB CDECL()
  _gtk_reserved4 AS SUB CDECL()
...
DECLARE FUNCTION gtk_toolbar_append_element(BYVAL AS GtkToolbar PTR, BYVAL AS GtkToolbarChildType, BYVAL AS GtkWidget PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS GtkWidget PTR, BYVAL AS GCallback, BYVAL AS gpointer) AS GtkWidget PTR
DECLARE FUNCTION gtk_toolbar_append_item(BYVAL AS GtkToolbar PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS GtkWidget PTR, BYVAL AS GCallback, BYVAL AS gpointer) AS GtkWidget PTR
DECLARE SUB gtk_toolbar_append_space(BYVAL AS GtkToolbar PTR)
DECLARE SUB gtk_toolbar_append_widget(BYVAL AS GtkToolbar PTR, BYVAL AS GtkWidget PTR, BYVAL AS const char PTR, BYVAL AS const char PTR)
...
DECLARE FUNCTION gtk_toolbar_insert_element(BYVAL AS GtkToolbar PTR, BYVAL AS GtkToolbarChildType, BYVAL AS GtkWidget PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS GtkWidget PTR, BYVAL AS GCallback, BYVAL AS gpointer, BYVAL AS gint) AS GtkWidget PTR
DECLARE FUNCTION gtk_toolbar_insert_item(BYVAL AS GtkToolbar PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS GtkWidget PTR, BYVAL AS GCallback, BYVAL AS gpointer, BYVAL AS gint) AS GtkWidget PTR
DECLARE SUB gtk_toolbar_insert_space(BYVAL AS GtkToolbar PTR, BYVAL AS gint)
DECLARE FUNCTION gtk_toolbar_insert_stock(BYVAL AS GtkToolbar PTR, BYVAL AS const gchar PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS GCallback, BYVAL AS gpointer, BYVAL AS gint) AS GtkWidget PTR
DECLARE SUB gtk_toolbar_insert_widget(BYVAL AS GtkToolbar PTR, BYVAL AS GtkWidget PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS gint)
DECLARE FUNCTION gtk_toolbar_prepend_element(BYVAL AS GtkToolbar PTR, BYVAL AS GtkToolbarChildType, BYVAL AS GtkWidget PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS GtkWidget PTR, BYVAL AS GCallback, BYVAL AS gpointer) AS GtkWidget PTR
DECLARE FUNCTION gtk_toolbar_prepend_item(BYVAL AS GtkToolbar PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS GtkWidget PTR, BYVAL AS GCallback, BYVAL AS gpointer) AS GtkWidget PTR
DECLARE SUB gtk_toolbar_prepend_space(BYVAL AS GtkToolbar PTR)
DECLARE SUB gtk_toolbar_prepend_widget(BYVAL AS GtkToolbar PTR, BYVAL AS GtkWidget PTR, BYVAL AS const char PTR, BYVAL AS const char PTR)
...
#DEFINE GTK_TOOLTIPS_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_TOOLTIPS, GtkTooltipsClass))
#DEFINE GTK_IS_TOOLTIPS(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_TOOLTIPS))
#DEFINE GTK_IS_CLASS_TOOLTIPS(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_TOOLTIPS))
...
#DEFINE GTK_VRULER_CLASS(obj) (G_TYPE_CHECK_CLASS_CAST((obj), GTK_TYPE_VRULER, GtkVRulerClass))
#DEFINE GTK_IS_VRULER(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_VRULER))
#DEFINE GTK_IS_CLASS_VRULER(obj) (G_TYPE_CHECK_CLASS_TYPE((obj), GTK_TYPE_VRULER))
...
DECLARE FUNCTION gtk_init_with_args(BYVAL AS gint /'int'/ PTR, BYVAL AS char PTR PTR PTR, BYVAL AS const char PTR, BYVAL AS GOptionEntry PTR, BYVAL AS const char PTR, BYVAL AS GError PTR PTR) AS gboolean
...
DECLARE SUB gtk_marshal_BOOLEAN__POINTER(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_BOOLEAN__POINTER_INT_INT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_BOOLEAN__POINTER_INT_INT_UINT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_BOOLEAN__POINTER_POINTER_INT_INT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_BOOLEAN__POINTER_STRING_STRING_POINTER(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_BOOLEAN__VOID(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_ENUM__ENUM(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_INT__POINTER(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_INT__POINTER_CHAR_CHAR(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__ENUM_FLOAT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__ENUM_FLOAT_BOOLEAN(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__INT_INT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__INT_INT_POINTER(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_INT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_INT_INT_POINTER_UINT_UINT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_POINTER(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_POINTER_POINTER(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_POINTER_UINT_UINT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_STRING_STRING(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_UINT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_UINT_ENUM(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__POINTER_UINT_UINT(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__STRING_INT_POINTER(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__UINT_POINTER_UINT_ENUM_ENUM_POINTER(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__UINT_POINTER_UINT_UINT_ENUM(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
DECLARE SUB gtk_marshal_VOID__UINT_STRING(BYVAL AS GClosure PTR, BYVAL AS GValue PTR, BYVAL AS guint, BYVAL AS const GValue PTR, BYVAL AS gpointer, BYVAL AS gpointer)
...
DECLARE SUB gtk_stock_add_ ALIAS "gtk_stock_add"(BYVAL AS GtkStockItem PTR, BYVAL AS guint)
DECLARE SUB gtk_stock_add_static(BYVAL AS GtkStockItem PTR, BYVAL AS guint)
...
DECLARE SUB gtk_text_anchored_child_set_layout(BYVAL AS GtkWidget PTR, BYVAL AS GtkTextLayout PTR)
