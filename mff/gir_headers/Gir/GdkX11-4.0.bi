...
' Auto-translated from file /usr/share/gir-1.0/GdkX11-4.0.gir
...
DECLARE FUNCTION gdk_x11_display_string_to_compound_text(BYVAL AS GdkDisplay PTR, BYVAL AS const gchar PTR, BYVAL AS GdkAtom PTR, BYVAL AS gint PTR, BYVAL AS guchar PTR PTR, BYVAL AS gint PTR) AS gint
DECLARE FUNCTION gdk_x11_display_text_property_to_text_list(BYVAL AS GdkDisplay PTR, BYVAL AS GdkAtom, BYVAL AS gint, BYVAL AS const guchar PTR, BYVAL AS gint, BYVAL AS gchar PTR PTR PTR) AS gint
DECLARE SUB gdk_x11_display_ungrab(BYVAL AS GdkDisplay PTR)
DECLARE FUNCTION gdk_x11_display_utf8_to_compound_text(BYVAL AS GdkDisplay PTR, BYVAL AS const gchar PTR, BYVAL AS GdkAtom PTR, BYVAL AS gint PTR, BYVAL AS guchar PTR PTR, BYVAL AS gint PTR) AS gboolean
...
DECLARE FUNCTION gdk_x11_screen_get_screen_number(BYVAL AS GdkScreen PTR) AS int
DECLARE FUNCTION gdk_x11_screen_get_window_manager_name(BYVAL AS GdkScreen PTR) AS const char PTR
DECLARE FUNCTION gdk_x11_screen_get_xscreen(BYVAL AS GdkScreen PTR) AS Screen PTR
DECLARE FUNCTION gdk_x11_screen_lookup_visual(BYVAL AS GdkScreen PTR, BYVAL AS VisualID) AS GdkVisual PTR
DECLARE FUNCTION gdk_x11_screen_supports_net_wm_hint(BYVAL AS GdkScreen PTR, BYVAL AS GdkAtom) AS gboolean
...
DECLARE FUNCTION gdk_x11_window_foreign_new_for_display(BYVAL AS GdkDisplay PTR, BYVAL AS Window) AS GdkWindow PTR
DECLARE FUNCTION gdk_x11_window_lookup_for_display(BYVAL AS GdkDisplay PTR, BYVAL AS Window) AS GdkWindow PTR
DECLARE FUNCTION gdk_x11_window_get_desktop(BYVAL AS GdkWindow PTR) AS guint32
DECLARE FUNCTION gdk_x11_window_get_xid(BYVAL AS GdkWindow PTR) AS Window
...
DECLARE SUB gdk_x11_window_set_frame_extents(BYVAL AS GdkWindow PTR, BYVAL AS int, BYVAL AS int, BYVAL AS int, BYVAL AS int)
DECLARE SUB gdk_x11_window_set_frame_sync_enabled(BYVAL AS GdkWindow PTR, BYVAL AS gboolean)
DECLARE SUB gdk_x11_window_set_theme_variant(BYVAL AS GdkWindow PTR, BYVAL AS const char PTR)
...
DECLARE FUNCTION gdk_x11_atom_to_xatom(BYVAL AS GdkAtom) AS Atom
DECLARE FUNCTION gdk_x11_atom_to_xatom_for_display(BYVAL AS GdkDisplay PTR, BYVAL AS GdkAtom) AS Atom
...
DECLARE FUNCTION gdk_x11_get_default_root_xwindow() AS Window
...
DECLARE FUNCTION gdk_x11_xatom_to_atom(BYVAL AS Atom) AS GdkAtom
DECLARE FUNCTION gdk_x11_xatom_to_atom_for_display(BYVAL AS GdkDisplay PTR, BYVAL AS Atom) AS GdkAtom
END EXTERN
