...
Namespace My.Sys.Forms
    #IfNDef Control_Off
        ...
        Type Control Extends Component
            ...
            Public:
                ...
                Declare Property Parent As Control Ptr 'ContainerControl
    ...
    '    End Property
        ...
        #IfNDef Move_Off
            ...
            If FParent Then
                iLeft = iLeft + FParent->Margins.Left
                iTop = iTop + FParent->Margins.Top
                iWidth = iWidth - FParent->Margins.Left - FParent->Margins.Right
                iHeight = iHeight - FParent->Margins.Top - FParent->Margins.Bottom
            End If
                        ...
                        If Cast(Integer, .Anchor.Left) + Cast(Integer, .Anchor.Right) + Cast(Integer, .Anchor.Top) + Cast(Integer, .Anchor.Bottom) <> 0 Then
                            If .FHandle Then
                                ...
                                If .Anchor.Left <> asNone Then
                                    If .Anchor.Left = asAnchorProportional Then aLeft = This.Width / .FAnchoredParentWidth * .FAnchoredLeft
                                    If .Anchor.Right <> asNone Then aWidth = This.Width - aLeft - IIF(.Anchor.Right = asAnchor, .FAnchoredRight, This.Width / .FAnchoredParentWidth * .FAnchoredRight)
                                ElseIf .Anchor.Right <> asNone Then
                                    aLeft = This.Width - .Width - IIF(.Anchor.Right = asAnchor, .FAnchoredRight, This.Width / .FAnchoredParentWidth * .FAnchoredRight)
                                End If
                                If .Anchor.Top <> asNone Then
                                    If .Anchor.Top = asAnchorProportional Then aTop = This.Height / .FAnchoredParentHeight * .FAnchoredTop
                                    If .Anchor.Bottom <> asNone Then aHeight = This.Height - aTop - IIF(.Anchor.Bottom = asAnchor, .FAnchoredBottom, This.Height / .FAnchoredParentHeight * .FAnchoredBottom)
                                ElseIf .Anchor.Bottom <> asNone Then
                                    aTop = This.Height - .Height - IIF(.Anchor.Bottom = asAnchor, .FAnchoredBottom, This.Height / .FAnchoredParentHeight * .FAnchoredBottom)
                                End If
