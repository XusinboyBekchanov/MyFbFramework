...
declare function FBS_Load_WAVFile(byref Filename as WString , _
                                  byval phWave   as integer ptr) as boolean
#ifndef NO_MP3
' create hWave from *.mp3,*.mp2,*.mp file
declare function FBS_Load_MP3File(byref Filename as WString      , _
...
declare function FBS_Load_MODFile(byref Filename as WString       , _
                                  byval phWave  as integer ptr) as boolean
#endif

#ifndef NO_OGG
' create hWave from *.ogg file
declare function FBS_Load_OGGFile(byref Filename as WString      , _
...
enum FBS_STREAM_TYPES
 ...
 #ifndef NO_MP3
declare function FBS_Create_MP3Stream(byref Filename as WString) as boolean
...
declare function FBS_Disable_MP3StreamCallback() as boolean
 ...
 #ifndef NO_SID
declare function FBS_Create_SIDStream(byref Filename as WString, _
